...
func (c *core) CurrentProposer() (*big.Int, common.Address) {
	if c.valSet == nil {
	...
	return c.current.Sequence(), proposer.Address()
}
...
func (c *core) startNewRound(round *big.Int) {
	...
	logger.Debug("New round", "last block number", lastProposal.Number().Uint64(), "new_round", newView.Round, "new_seq", newView.Sequence, "new_proposer", c.valSet.GetProposer(), "valSet", c.valSet.List(), "size", c.valSet.Size(), "IsProposer", c.IsProposer())
}
