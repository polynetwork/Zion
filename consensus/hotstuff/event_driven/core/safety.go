...
func (e *EventDrivenEngine) makeVote(hash common.Hash, view *hotstuff.View, justifyQC *hotstuff.QuorumCert) (*Vote, error) {
	...
	curHeight := e.curHeight.Uint64()
	startHeight := e.epochHeightStart.Uint64()

	if curHeight >= startHeight+2 {
