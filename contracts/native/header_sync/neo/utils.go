...
func verifyHeader(native *native.NativeContract, chainID uint64, header *NeoBlockHeader) error {
...
func VerifyCrossChainMsgSig(native *native.NativeContract, chainID uint64, crossChainMsg *NeoCrossChainMsg) error {
	neoConsensus, err := getConsensusValByChainId(native, chainID)
	if err != nil {
