...
var IAllocProxyFuncSigs = map[string]string{
	...
	"06fdde03": "name()",
	"6241a1c9": "verifyHeaderAndMint(bytes,bytes,bytes)",
}
...
// VerifyHeaderAndMint is a paid mutator transaction binding the contract method 0x6241a1c9.
//
// Solidity: function verifyHeaderAndMint(bytes header, bytes rawCrossTx, bytes proof) returns(bool)
func (_IAllocProxy *IAllocProxyTransactor) VerifyHeaderAndMint(opts *bind.TransactOpts, header []byte, rawCrossTx []byte, proof []byte) (*types.Transaction, error) {
	return _IAllocProxy.contract.Transact(opts, "verifyHeaderAndMint", header, rawCrossTx, proof)
}

// VerifyHeaderAndMint is a paid mutator transaction binding the contract method 0x6241a1c9.
//
// Solidity: function verifyHeaderAndMint(bytes header, bytes rawCrossTx, bytes proof) returns(bool)
func (_IAllocProxy *IAllocProxySession) VerifyHeaderAndMint(header []byte, rawCrossTx []byte, proof []byte) (*types.Transaction, error) {
	return _IAllocProxy.Contract.VerifyHeaderAndMint(&_IAllocProxy.TransactOpts, header, rawCrossTx, proof)
}

// VerifyHeaderAndMint is a paid mutator transaction binding the contract method 0x6241a1c9.
//
// Solidity: function verifyHeaderAndMint(bytes header, bytes rawCrossTx, bytes proof) returns(bool)
func (_IAllocProxy *IAllocProxyTransactorSession) VerifyHeaderAndMint(header []byte, rawCrossTx []byte, proof []byte) (*types.Transaction, error) {
	return _IAllocProxy.Contract.VerifyHeaderAndMint(&_IAllocProxy.TransactOpts, header, rawCrossTx, proof)
}
